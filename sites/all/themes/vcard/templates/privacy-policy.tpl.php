<section id="privacy-policy">
    <div class="nano">
        <div class="nano-content">
            <article>
                <h1>Bind-Up Privacy Policy</h1>

                <h2 class="text-center">Policy summary</h2>
                <h5>
                    <strong>Contacts:</strong>
                </h5>
                <p>
                    If you have any questions, or some of the terms are
                    violating your rights , please contact us to following
                    email: <strong>amberway.ua@gmail.com</strong>
                </p>
                ...
                <ul>
                    <li>
                        Contacts permission, Phone permission, SMS permission
                ...
                <h2 class="text-center">Full policy</h2>
                <h5><strong>Owner and Data Controller</strong></h5>
                ...
                <p>
                    ...
                    Contacts permission, Phone permission, SMS permission,
                    Storage permission and email address.
                </p>
                <p>
                ...
                <p>
                    ...
                    purposes: <br/>
                    Device permissions for Personal Data access and
                    Registration and authentication.
                </p>
                <p>
                ...
                <p>
                    ...
                    impact the proper functioning of this Application.
                </p>
                <p>
                ...
                <p><strong>Contacts permission</strong></p>
                <p>
                    Used for accessing contacts and profiles on the User's
                    device, including the changing of entries.
                </p>

                <p><strong>Phone permission</strong></p>
                <p>
                    Used for accessing a host of typical features associated
                    with telephony. This enables, for instance, read-only access
                    to the “phone state”, which means it enables access to the
                    phone number of the device, current mobile network
                    information, or the status of any ongoing calls.
                </p>

                <p><strong>SMS permission</strong></p>
                <p>
                    Used for accessing features related to the User's messaging
                    including the sending, receiving and reading of SMS.
                </p>
                ...
                <h5><strong>The rights of Users</strong></h5>
                <p>
                ...
                <p>
                    <strong><u>Access their Data</u></strong>.
                ...
                <p>
                    <strong><u>Have their Personal Data deleted or otherwise
                            removed</u></strong>.
                    Users have the right, under certain circumstances, to obtain
                    the erasure of their Data from the Owner.
                </p>
                <p>
                    <strong><u>Receive their Data and have it transferred to
                            another controller</u></strong>.
                ...
                <p>
                    <strong><u>Lodge a complaint</u></strong>.
                    Users have the right to bring a claim before their competent
                    data protection authority.
                </p>

                <p>
                    <strong>Details about the right to object to
                        processing</strong>
                </p>
                <p>
                ...
                <h5>
                    <strong>Additional information about Data collection and
                        processing</strong>
                </h5>
                ...
                <p>
                    <strong>Additional information about User's Personal
                        Data</strong>
                </p>
                <p>
                ...
                <p>
                    ...
                    policy at any time by giving notice to its Users on this
                    page and possibly within this Application and/or - as far as
